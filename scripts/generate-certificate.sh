...
openssl req -x509 -new -key $ROOT_CA_KEY -out $ROOT_CA -days 365 -SHA256 -subj "/C=FR/ST=Paris/O=Ankama Games" -config root.cnf -extensions v3_ca
...
openssl req -out server.csr -key $SERVER_KEY -new -days 365 -SHA256 -subj "/C=FR/ST=Paris/O=Ankama Games/CN=localhost"
